...
app.MapPost("/AddVideo", async (context) =>
{
    ...
    try
    {
        ...
        var dict = context.Request.Form.ToDictionary(x => x.Key, x => x.Value.ToString()); //Èלÿ פאיכא

        if (context.Request.Form.Files.Count == 1)
        {
            fileData = context.Request.Form.Files[0]; // Ôאיכ
        ...
        else
        {
            ...
            fileData = context.Request.Form.Files[1]; // Ôאיכ
